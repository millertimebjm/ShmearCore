...
Entity Framework Core has dramatically eased the burden of trying to keep separate an environment for doing automated testing vs. having a SQL Server development environment where I can execute and debug my application.  The benefits of using an "InMemroy" connection string from Entity Framework Core include:
